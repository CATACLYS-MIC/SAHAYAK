...
const COMMON_PHRASES: Record<string, Record<Language, string>> = {
  ...
  'River Level': { ne: 'नदी जलस्तर', en: 'River Level', new: 'खुसि लः स्तर', mai: 'नदी जलस्तर', hi: 'नदी जल स्तर' },
  'Soil Moisture': { ne: 'माटोको आर्द्रता', en: 'Soil Moisture', new: 'चाया आर्द्रता', mai: 'माटिक आर्द्रता', hi: 'मिट्टी की नमी' },
  'Rainfall (24h)': { ne: 'वर्षा (२४ घण्टा)', en: 'Rainfall (24h)', new: 'वा (२४ घण्टा)', mai: 'वर्षा (२४ घंटा)', hi: 'वर्षा (२४ घंटे)' },
  'Barometric Pressure': { ne: 'वायुमण्डलीय चाप', en: 'Barometric Pressure', new: 'वायुमण्डलीय चाप', mai: 'वायुमंडलीय दबाव', hi: 'वायुमंडलीय दबाव' },
  'Ground IoT Network': { ne: 'ग्राउन्ड आईओटी नेटवर्क', en: 'Ground IoT Network', new: 'ग्राउन्ड आईओटी नेटवर्क', mai: 'ग्राउंड आईओटी नेटवर्क', hi: 'ग्राउंड आईओटी नेटवर्क' },
  'Ground IoT Network Active': { ne: 'ग्राउन्ड आईओटी नेटवर्क सक्रिय', en: 'Ground IoT Network Active', new: 'ग्राउन्ड आईओटी नेटवर्क सक्रिय', mai: 'ग्राउंड आईओटी नेटवर्क सक्रिय', hi: 'ग्राउंड आईओटी नेटवर्क सक्रिय' },
  '15s Telemetry Pulse': { ne: '१५ सेकेन्ड टेलिमेट्री पल्स', en: '15s Telemetry Pulse', new: '१५ सेकेन्ड टेलिमेट्री पल्स', mai: '१५ सेकेन्ड टेलीमेट्री पल्स', hi: '१५ सेकंड टेलीमेट्री पल्स' },
  'Stable': { ne: 'स्थिर', en: 'Stable', new: 'स्थिर', mai: 'स्थिर', hi: 'स्थिर' },
  'Rising': { ne: 'बढ्दो', en: 'Rising', new: 'बढेजुगु', mai: 'बढ़ैत', hi: 'बढ़ता हुआ' },
  'Falling': { ne: 'घट्दो', en: 'Falling', new: 'घटेजुगु', mai: 'घटैत', hi: 'घटता हुआ' },

  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-[1600px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Logistics & Team Command</h2>
          <p className="text-slate-600 dark:text-slate-400 mt-1">Coordinate relief supplies, distribution routes, and volunteer teams.</p>
        </div>
        <div className="flex items-center gap-3">
          <Badge variant="outline" className="border-blue-200 bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:border-blue-800 dark:text-blue-300">DEMO MODE</Badge>
        </div>
      </div>
      ...
      <div className="flex space-x-1 rounded-lg bg-slate-100 dark:bg-slate-900 p-1 w-full max-w-md">
        ...
        >
          <Users className="w-4 h-4 mr-2" /> Teams & Coverage
        </button>
      </div>
